using CommonCartridge.Core.Interfaces.v1_1;
using CommonCartridge.Core.Models.Parser.v1_1;
using CommonCartridge.Core.Models.v1_1;
using System;
using System.IO;
...
{
    public class V1_1Parser : IV1_1Parser
    {
        ...
        public CCParserResult FromCCXml(string content, string directory)
        {
            ...
            try
            {
                ...
                {
                    foreach (var r in result.Manifest.Resources.Resource.Where(r => r.Type != ResourceTypeType.webcontent))
                    {
