...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="ManifestMetadata.Type", Namespace="http://www.imsglobal.org/xsd/imsccv1p3/imscp_v1p1")]
...
public partial class ManifestMetadataType
{
    ...
    private CurriculumStandardsMetadataSetType _curriculumStandardsMetadataSet;
    #endregion
    
    public ManifestMetadataType()
    {
        this._curriculumStandardsMetadataSet = new CurriculumStandardsMetadataSetType();
    ...
    [System.Xml.Serialization.XmlElementAttribute(Namespace="http://ltsc.ieee.org/xsd/imsccv1p3/LOM/manifest", ElementName="lom")]
    public LOMType Lom
    {
        get
        {
    ...
    [System.Xml.Serialization.XmlElementAttribute(Namespace="http://www.imsglobal.org/xsd/imsccv1p3/imscsmd_v1p0", ElementName="curriculumStandardsMetadataSet")]
    public CurriculumStandardsMetadataSetType CurriculumStandardsMetadataSet
    {
        get
        {
