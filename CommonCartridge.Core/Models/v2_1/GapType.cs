...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="Gap.Type", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1")]
[System.Xml.Serialization.XmlRootAttribute("gap", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1", IsNullable=false)]
public partial class GapType : EmptyPrimitiveTypeType
{
    ...
    private GapTypeShowHide _showHide;
    ...
    public GapType()
    {
        ...
        this._fixed = false;
        this._showHide = GapTypeShowHide.show;
    ...
    public GapTypeShowHide ShowHide
    {
        get
        {
