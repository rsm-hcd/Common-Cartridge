...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="StatsOperator.Type", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1")]
[System.Xml.Serialization.XmlRootAttribute("statsOperator", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1", IsNullable=false)]
public partial class StatsOperatorType
{
    ...
    private StatsOperatorTypeName _name;
    #endregion
    ...
    public StatsOperatorTypeName Name
    {
        get
        {
            return this._name;
