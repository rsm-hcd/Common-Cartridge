...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="Equal.Type", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1")]
[System.Xml.Serialization.XmlRootAttribute("equal", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1", IsNullable=false)]
public partial class EqualType
{
    ...
    private EqualTypeToleranceMode _toleranceMode;
    
    private List<string> _tolerance;
    ...
    public EqualType()
    {
        this._tolerance = new List<string>();
        this._toleranceMode = EqualTypeToleranceMode.exact;
        this._includeLowerBound = true;
        this._includeUpperBound = true;
    }
    ...
    [System.Xml.Serialization.XmlAttributeAttribute(AttributeName="toleranceMode")]
    [System.ComponentModel.DefaultValueAttribute(EqualTypeToleranceMode.exact)]
    public EqualTypeToleranceMode ToleranceMode
    {
        get
        {
            return this._toleranceMode;
        }
        set
        {
            this._toleranceMode = value;
        }
    }
    
    [System.Xml.Serialization.XmlAttributeAttribute(AttributeName="tolerance")]
    public List<string> Tolerance
    {
        get
        {
    ...
    [System.Xml.Serialization.XmlAttributeAttribute(AttributeName="includeLowerBound")]
    ...
    [System.Xml.Serialization.XmlAttributeAttribute(AttributeName="includeUpperBound")]
    [System.ComponentModel.DefaultValueAttribute(true)]
