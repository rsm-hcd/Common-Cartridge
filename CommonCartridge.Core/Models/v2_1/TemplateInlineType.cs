...
[System.Xml.Serialization.XmlRootAttribute("TemplateInlineType")]
public partial class TemplateInlineType
{
    ...
    private TemplateInlineTypeShowHide _showHide;
    
    private string _identifier;
    #endregion
    
    public TemplateInlineType()
    {
        this._class = new List<string>();
        this._text = new List<string>();
        this._showHide = TemplateInlineTypeShowHide.show;
    }
    ...
    public TemplateInlineTypeShowHide ShowHide
    {
        get
        {
