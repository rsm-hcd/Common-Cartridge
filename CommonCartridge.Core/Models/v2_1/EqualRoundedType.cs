...
[System.Xml.Serialization.XmlTypeAttribute(TypeName="EqualRounded.Type", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1")]
[System.Xml.Serialization.XmlRootAttribute("equalRounded", Namespace="http://www.imsglobal.org/xsd/imsqti_v2p1", IsNullable=false)]
public partial class EqualRoundedType
{
    ...
    private EqualRoundedTypeRoundingMode _roundingMode;
    
    private string _figures;
    #endregion
    
    public EqualRoundedType()
    {
        this._roundingMode = EqualRoundedTypeRoundingMode.significantFigures;
    }
    ...
    [System.Xml.Serialization.XmlAttributeAttribute(AttributeName="roundingMode")]
    [System.ComponentModel.DefaultValueAttribute(EqualRoundedTypeRoundingMode.significantFigures)]
    public EqualRoundedTypeRoundingMode RoundingMode
    {
        get
        {
    ...
    [System.Xml.Serialization.XmlAttributeAttribute(AttributeName="figures")]
